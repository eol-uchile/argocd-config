...
# dev
kubectl --context oeol -n moodle-ing create secret generic moodle-dev-config --from-file=moodle.php=./moodle-dev.php --dry-run=client -o yaml | kubeseal --context oeol --controller-namespace sealed-secrets -o yaml > ../../moodle-virtuallabx/secrets/moodle-dev-config.yaml
