...
# prod
kubectl --context oeol -n moodle-ing create secret generic moodle4-config --from-file=moodle.php=./moodle4.php --dry-run=client -o yaml | kubeseal --context oeol --controller-namespace sealed-secrets -o yaml > ../../moodle-virtuallabx/secrets/moodle-config.yaml
