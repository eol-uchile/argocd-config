...
# dev
kubectl --context oeol -n moodle-ing create secret generic moodle4-dev-config --from-file=moodle.php=./moodle4-dev.php --dry-run=client -o yaml | kubeseal --context oeol --controller-namespace sealed-secrets -o yaml > ../../moodle-virtuallabx-oeol/secrets/moodle-dev-config.yaml
...
# prod
kubectl --context openuchile -n moodle-ing create secret generic moodle4-config --from-file=moodle.php=./moodle4.php --dry-run=client -o yaml | kubeseal --context openuchile --controller-namespace sealed-secrets -o yaml > ../../moodle-virtuallabx/secrets/moodle-config.yaml
