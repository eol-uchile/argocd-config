...
kubectl --context openuchile -n moodle-ing create secret generic moodle4-dev-config --from-file=moodle.php=./moodle4-dev.php --dry-run=client -o yaml | kubeseal --context openuchile --controller-namespace sealed-secrets -o yaml > ../../moodle-virtuallabx/secrets/moodle4-dev-config.yaml
