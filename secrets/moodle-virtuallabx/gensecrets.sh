...
kubectl --context openuchile -n moodle-ing create secret generic moodle-config --from-file=moodle.php=./moodle.php --dry-run=client -o yaml | kubeseal --controller-namespace sealed-secrets -o yaml > ../../moodle-virtuallabx/secrets/moodle-config.yaml
